...
import { dist_exports, init_dist } from './chunk-NC5RQAMV.js';
import './chunk-ZWL5HDF3.js';
import { require_react } from './chunk-2PA4WPI3.js';
import { __commonJS, __toCommonJS } from './chunk-ROME4SDB.js';
...
var require_LinkContainer = __commonJS({
  'node_modules/react-router-bootstrap/LinkContainer.js'(exports) {
    ...
    var LinkContainer = function LinkContainer2(_ref) {
      ...
      var href = (0, _reactRouterDom.useHref)(
        typeof to === 'string'
          ? {
              pathname: to,
            }
    ...
    LinkContainer.propTypes = {
      ...
      activeStyle: _propTypes['default'].objectOf(
        _propTypes['default'].oneOfType([_propTypes['default'].string, _propTypes['default'].number]),
      ),
