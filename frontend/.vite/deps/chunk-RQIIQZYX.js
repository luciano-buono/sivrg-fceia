import { ENTERED, ENTERING, EXITED, EXITING, Transition_default, addClass, removeClass } from './chunk-GHIJG3ZY.js';
import { require_classnames, require_jsx_runtime, useBootstrapPrefix } from './chunk-5OCWVORX.js';
import { require_prop_types } from './chunk-YLFKALMF.js';
import { _objectWithoutPropertiesLoose } from './chunk-PSGUSLG5.js';
import { init_inheritsLoose } from './chunk-S6CY5J6A.js';
...
var NavbarBrand = React3.forwardRef(({ bsPrefix, className, as, ...props }, ref) => {
...
var Collapse = import_react5.default.forwardRef(
  (
    ...
    const handleEnter = (0, import_react5.useMemo)(
      () =>
    ...
    const handleEntering = (0, import_react5.useMemo)(
      () =>
        createChainedFunction_default((elem) => {
    ...
    const handleEntered = (0, import_react5.useMemo)(
      () =>
        createChainedFunction_default((elem) => {
    ...
    const handleExit = (0, import_react5.useMemo)(
      () =>
        createChainedFunction_default((elem) => {
    ...
    const handleExiting = (0, import_react5.useMemo)(
      () =>
        createChainedFunction_default((elem) => {
          elem.style[computedDimension] = null;
        }, onExiting),
...
var NavbarCollapse = React7.forwardRef(({ children, bsPrefix, ...props }, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, 'navbar-collapse');
  const context2 = (0, import_react6.useContext)(NavbarContext_default);
...
var NavbarToggle = React8.forwardRef(
  (
    ...
    const { onToggle, expanded } = (0, import_react9.useContext)(NavbarContext_default) || {};
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react12.useMemo)(
      () =>
...
var ModalManager = class {
  ...
  setContainerStyle(containerState) {
    ...
    if (containerState.scrollBarWidth) {
      style2[paddingProp] = `${
        parseInt(css_default(container, paddingProp) || '0', 10) + containerState.scrollBarWidth
      }px`;
    }
...
function useWaitForDOMRef(ref, onResolved) {
  ...
  const [resolvedRef, setRef] = (0, import_react18.useState)(() =>
...
function useTransition({ in: inProp, onTransition }) {
  ...
  const isInitialRef = (0, import_react20.useRef)(true);
...
function ImperativeTransition({ children, in: inProp, onExited, onEntered, transition }) {
  const [exited, setExited] = (0, import_react20.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
...
function useModalManager(provided) {
  ...
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react21.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react21.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, []),
  });
}
var Modal = (0, import_react21.forwardRef)((_ref, ref) => {
  let {
      show = false,
      role = 'dialog',
      className,
    ...
    rest = _objectWithoutPropertiesLoose2(_ref, _excluded);
  ...
  (0, import_react21.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const handleShow = useEventCallback(() => {
    ...
    if (autoFocus) {
      ...
      const currentActiveElement = activeElement(
        (_modal$dialog$ownerDo = (_modal$dialog = modal.dialog) == null ? void 0 : _modal$dialog.ownerDocument) != null
  ...
  return (0, import_jsx_runtime7.jsx)(import_jsx_runtime8.Fragment, {
    children: import_react_dom2.default.createPortal(
      (0, import_jsx_runtime9.jsxs)(import_jsx_runtime8.Fragment, {
...
var Fade = React11.forwardRef(({ className, children, transitionClasses = {}, onEnter, ...rest }, ref) => {
  const props = {
    in: false,
    timeout: 300,
    mountOnEnter: false,
  ...
  const handleEnter = (0, import_react22.useCallback)(
    (node, isAppearing) => {
...
var OffcanvasBody = React12.forwardRef(({ className, bsPrefix, as: Component = 'div', ...props }, ref) => {
...
var CloseButton = React15.forwardRef(({ className, variant, 'aria-label': ariaLabel = 'Close', ...props }, ref) =>
...
var AbstractModalHeader = React16.forwardRef(
  ({ closeLabel = 'Close', closeVariant, closeButton = false, onHide, children, ...props }, ref) => {
    const context2 = (0, import_react23.useContext)(ModalContext_default);
    ...
    return (0, import_jsx_runtime15.jsxs)('div', {
      ...
      children: [
        children,
        closeButton &&
          (0, import_jsx_runtime14.jsx)(CloseButton_default, {
...
var OffcanvasTitle = React19.forwardRef(({ className, bsPrefix, as: Component = DivStyledAsH5, ...props }, ref) => {
...
var Offcanvas = React20.forwardRef(
  (
    ...
    const modalManager = (0, import_react24.useRef)();
    bsPrefix = useBootstrapPrefix(bsPrefix, 'offcanvas');
    const { onToggle } = (0, import_react24.useContext)(NavbarContext_default) || {};
    const [showOffcanvas, setShowOffcanvas] = (0, import_react24.useState)(false);
    ...
    const renderBackdrop = (0, import_react24.useCallback)(
      (backdropProps) =>
    ...
    return (0, import_jsx_runtime21.jsxs)(import_jsx_runtime20.Fragment, {
      children: [
        ...
        (0, import_jsx_runtime19.jsx)(ModalContext_default.Provider, {
          value: modalContext,
...
var NavbarText = React22.forwardRef(({ className, bsPrefix, as: Component = 'span', ...props }, ref) => {
...
var Navbar = React23.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react26.useCallback)(
    (...args) => {
  ...
  const navbarContext = (0, import_react26.useMemo)(
    () => ({
...
//# sourceMappingURL=chunk-RQIIQZYX.js.map
