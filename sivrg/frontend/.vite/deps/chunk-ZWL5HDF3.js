...
import { __esm, __toESM } from './chunk-ROME4SDB.js';
  ...
  async function callLoadersAndMaybeResolveData(currentMatches, matches, matchesToLoad, fetchersToLoad, request) {
    let results = await Promise.all([
      ...matchesToLoad.map((match) =>
        callLoaderOrAction('loader', request, match, matches, manifest, mapRouteProperties2, basename),
      ),
...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  if (errors != null) {
    ...
    !(errorIndex >= 0)
      ? true
        ? invariant(false, 'Could not find a matching route for errors on route IDs: ' + Object.keys(errors).join(','))
        : invariant(false)
      : void 0;
...
react-router/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZWL5HDF3.js.map
