...
var _addClass = function addClass2(node, classes2) {
  return (
    node &&
    classes2 &&
    classes2.split(' ').forEach(function (c) {
...
var ReplaceTransition = (function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = import_react5.default.Children.toArray(children2),
    ...
    return import_react5.default.createElement(
      ...
      props,
      inProp
        ? import_react5.default.cloneElement(first, {
            key: 'first',
...
function areChildrenDifferent(oldChildren, newChildren) {
  ...
  if (
    import_react6.default.isValidElement(oldChildren) &&
    import_react6.default.isValidElement(newChildren) &&
...
var enterRenders =
  ...
  (_enterRenders[modes.in] = function (_ref4) {
    ...
    return [
      import_react6.default.cloneElement(current, {
        in: false,
        onExited: callHook(current, 'onExited', function () {
          changeState(
            ENTERED,
...
var NotificationContainer = (0, import_react7.forwardRef)((_a, ref) => {
  var _b = _a,
    { data, onHide, autoClose } = _b,
    others = __objRest(_b, ['data', 'onHide', 'autoClose']);
  const _a2 = data,
    { autoClose: _autoClose, message } = _a2,
    notificationProps = __objRest(_a2, ['autoClose', 'message']);
...
var varsResolver = createVarsResolver((_, { zIndex, position, containerWidth }) => {
  const [vertical, horizontal] = position.split('-');
  return {
    root: {
      ...
      '--notifications-left':
        horizontal === 'left' ? 'var(--mantine-spacing-md)' : horizontal === 'center' ? '50%' : void 0,
...
var Notifications = factory((_props, ref) => {
  ...
  return import_react8.default.createElement(
    OptionalPortal,
    __spreadValues4({ withinPortal }, portalProps),
    import_react8.default.createElement(
      Box,
      __spreadValues4(__spreadProps3(__spreadValues4({}, getStyles('root')), { ref }), others),
      import_react8.default.createElement(TransitionGroup_default, null, items),
    ),
  );
});
