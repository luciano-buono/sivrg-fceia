import {
  ...
  useWillUnmount,
  useWindow,
} from './chunk-RQIIQZYX.js';
import { ENTERING, EXITING, hasClass } from './chunk-GHIJG3ZY.js';
import { Button_default, Button_default2, useButtonProps } from './chunk-FA4MX7HL.js';
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL,
} from './chunk-5OCWVORX.js';
import { require_prop_types } from './chunk-YLFKALMF.js';
...
var AccordionBody = React4.forwardRef(
  (
    ...
    const { eventKey } = (0, import_react2.useContext)(AccordionItemContext_default);
...
function useAccordionButton(eventKey, onClick) {
  const { activeEventKey, onSelect, alwaysOpen } = (0, import_react3.useContext)(AccordionContext_default);
  return (e) => {
...
var AccordionButton = React5.forwardRef(
  (
    ...
    const { eventKey } = (0, import_react3.useContext)(AccordionItemContext_default);
    const accordionOnClick = useAccordionButton(eventKey, onClick);
    const { activeEventKey } = (0, import_react3.useContext)(AccordionContext_default);
...
var AlertHeading = React9.forwardRef(({ className, bsPrefix, as: Component2 = DivStyledAsH4, ...props }, ref) => {
...
var AlertLink = React11.forwardRef(({ className, bsPrefix, as: Component2 = Anchor_default, ...props }, ref) => {
...
var Alert = React12.forwardRef((uncontrolledProps, ref) => {
  ...
  const alert = (0, import_jsx_runtime11.jsxs)('div', {
    ...
    children: [
      dismissible &&
        (0, import_jsx_runtime10.jsx)(CloseButton_default, {
          onClick: handleClose,
...
var BreadcrumbItem = React14.forwardRef(
  (
    ...
    return (0, import_jsx_runtime13.jsx)(Component2, {
      ...
      children: active
        ? children
        : (0, import_jsx_runtime13.jsx)(LinkComponent, {
            ...linkProps,
            href,
            title,
            target,
...
var ButtonToolbar = React17.forwardRef(({ bsPrefix, className, role = 'toolbar', ...props }, ref) => {
...
var CardBody = React18.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var CardFooter = React19.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var CardImgOverlay = React23.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var CardLink = React24.forwardRef(({ className, bsPrefix, as: Component2 = 'a', ...props }, ref) => {
...
var CardSubtitle = React25.forwardRef(({ className, bsPrefix, as: Component2 = DivStyledAsH6, ...props }, ref) => {
...
var CardText = React26.forwardRef(({ className, bsPrefix, as: Component2 = 'p', ...props }, ref) => {
...
var CardTitle = React27.forwardRef(({ className, bsPrefix, as: Component2 = DivStyledAsH5, ...props }, ref) => {
...
var Card = React28.forwardRef(
  (
    ...
    return (0, import_jsx_runtime26.jsx)(Component2, {
      ...
      children: body
        ? (0, import_jsx_runtime26.jsx)(CardBody_default, {
            children,
          })
        : children,
    });
...
var CardGroup = React29.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var CarouselCaption = React30.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var Carousel = React33.forwardRef(({ defaultActiveIndex = 0, ...uncontrolledProps }, ref) => {
  const {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = 'div',
    bsPrefix,
  ...
  const prev = (0, import_react17.useCallback)(
    (event) => {
      if (isSliding) {
        return;
      }
  ...
  const handleEnter = (0, import_react17.useCallback)(
    (node) => {
  ...
  const handleMouseOver = (0, import_react17.useCallback)(
    (event) => {
      if (pause === 'hover') {
        setPaused(true);
      }
  ...
  const handleMouseOut = (0, import_react17.useCallback)(
    (event) => {
      setPaused(false);
  ...
  (0, import_react17.useEffect)(() => {
    ...
    intervalHandleRef.current = window.setInterval(
      ...
      (_ref = (_activeChildIntervalR = activeChildIntervalRef.current) != null ? _activeChildIntervalR : interval) !=
        null
        ? _ref
        : void 0,
    );
  ...
  const indicatorOnClicks = (0, import_react17.useMemo)(
    () =>
      indicators &&
      Array.from(
        {
    ...
    children: [
          ...
          children: map(children, (_, index) =>
            (0, import_jsx_runtime30.jsx)(
              'button',
              {
                ...
                'data-bs-target': '',
                'aria-label':
                  indicatorLabels != null && indicatorLabels.length ? indicatorLabels[index] : `Slide ${index + 1}`,
      ...
      (0, import_jsx_runtime30.jsx)('div', {
        ...
        children: map(children, (child, index) => {
          ...
          return slide
            ? (0, import_jsx_runtime30.jsx)(TransitionWrapper_default, {
                in: isActive,
      ...
      controls &&
        (0, import_jsx_runtime31.jsxs)(import_jsx_runtime32.Fragment, {
          children: [
            (wrap || activeIndex !== 0) &&
              (0, import_jsx_runtime31.jsxs)(Anchor_default, {
...
function getClippingParents(element) {
  ...
  return clippingParents2.filter(function (clippingParent) {
    return (
      isElement(clippingParent) && contains2(clippingParent, clipperElement) && getNodeName(clippingParent) !== 'body'
    );
  });
}
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  let { enabled = true, placement = 'bottom', strategy = 'absolute', modifiers = EMPTY_MODIFIERS } = _ref,
    config = _objectWithoutPropertiesLoose2(_ref, _excluded2);
...
function useClickOutside(ref, onClickOutside = noop, { disabled, clickTrigger = 'click' } = {}) {
  ...
  const handleMouseCapture = (0, import_react22.useCallback)(
    (e) => {
  ...
  (0, import_react22.useEffect)(() => {
    ...
    let currentEvent =
      (_ownerWindow$event = ownerWindow.event) != null
        ? _ownerWindow$event
        : (_ownerWindow$parent = ownerWindow.parent) == null
        ? void 0
...
function useDropdownMenu(options = {}) {
  ...
  const { placement, setMenu, menuElement, toggleElement } = context5 || {};
...
function DropdownMenu(_ref) {
  let { children } = _ref,
    options = _objectWithoutPropertiesLoose3(_ref, _excluded3);
...
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  ...
  return (0, import_react24.default).createElement(
    $b5e257d569688ac6$var$SSRContext.Provider,
    {
      value,
    },
    (0, import_react24.default).createElement(
...
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  ...
  if (ref.current === null && !isDisabled) {
    ...
    let currentOwner =
      (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react24.default)
...
var $b5e257d569688ac6$export$619500959fc48b26 =
  typeof (0, import_react24.default)['useId'] === 'function'
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react24.default)['useSyncExternalStore'] === 'function')
    return (0, import_react24.default)['useSyncExternalStore'](
...
var DropdownItem = React40.forwardRef((_ref, ref) => {
  let { eventKey, disabled, onClick, active, as: Component2 = Button_default } = _ref,
    props = _objectWithoutPropertiesLoose4(_ref, _excluded4);
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react27.useCallback)(
    (element) => {
      ref.current = element;
      forceUpdate();
    },
...
function Dropdown({
  ...
  useEventListener(
    (0, import_react27.useCallback)(() => window2.document, [window2]),
    'keydown',
    (event) => {
...
var DropdownItemText = React46.forwardRef(({ className, bsPrefix, as: Component2 = 'span', ...props }, ref) => {
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false) return ref;
  const warningRef = (0, import_react28.useCallback)(
    (refValue) => {
      !(refValue == null || !refValue.isReactComponent)
        ? true
          ...
          : (0, import_invariant.default)(false)
        : void 0;
    },
    [componentName],
  );
...
var DropdownMenu2 = React48.forwardRef(
  (
    ...
    const { align: contextAlign, drop, isRTL } = (0, import_react29.useContext)(DropdownContext_default2);
...
var DropdownButton = React51.forwardRef(
  (
    ...
    (0, import_jsx_runtime49.jsxs)(Dropdown_default2, {
      ref,
      ...props,
      children: [
        (0, import_jsx_runtime48.jsx)(DropdownToggle_default2, {
          id,
          href,
          size: size2,
          variant,
...
var FigureImage = React53.forwardRef(({ className, fluid = true, ...props }, ref) =>
  (0, import_jsx_runtime51.jsx)(Image_default, {
    ref,
    ...props,
    fluid,
...
var FigureCaption = React54.forwardRef(({ className, bsPrefix, as: Component2 = 'figcaption', ...props }, ref) => {
...
var Figure = React55.forwardRef(({ className, bsPrefix, as: Component2 = 'figure', ...props }, ref) => {
...
var FormCheckInput = React58.forwardRef(
  (
    ...
    const { controlId } = (0, import_react32.useContext)(FormContext_default);
...
var FormCheckLabel = React59.forwardRef(({ bsPrefix, className, htmlFor, ...props }, ref) => {
  const { controlId } = (0, import_react33.useContext)(FormContext_default);
...
var FormCheck = React60.forwardRef(
  (
    ...
    const { controlId } = (0, import_react34.useContext)(FormContext_default);
    ...
    return (0, import_jsx_runtime57.jsx)(FormContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime57.jsx)('div', {
        ...
        children:
          children ||
          (0, import_jsx_runtime59.jsxs)(import_jsx_runtime58.Fragment, {
            children: [
              input,
              hasLabel &&
                (0, import_jsx_runtime57.jsx)(FormCheckLabel_default, {
                  title,
                  children: label,
                }),
              feedback &&
                (0, import_jsx_runtime57.jsx)(Feedback_default, {
                  type: feedbackType,
...
var FormControl = React61.forwardRef(
  (
    ...
    const { controlId } = (0, import_react35.useContext)(FormContext_default);
...
var FormFloating = React62.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var FormLabel = React64.forwardRef(
  (
    ...
    const { controlId } = (0, import_react37.useContext)(FormContext_default);
    bsPrefix = useBootstrapPrefix(bsPrefix, 'form-label');
    let columnClass = 'col-form-label';
    if (typeof column === 'string') columnClass = `${columnClass} ${columnClass}-${column}`;
    const classes = (0, import_classnames48.default)(
      className,
      bsPrefix,
    ...
    htmlFor = htmlFor || controlId;
    if (column)
      return (0, import_jsx_runtime63.jsx)(Col_default, {
        ref,
        as: 'label',
        className: classes,
        htmlFor,
...
var FormRange = React65.forwardRef(({ bsPrefix, className, id, ...props }, ref) => {
  const { controlId } = (0, import_react38.useContext)(FormContext_default);
...
var FormSelect = React66.forwardRef(
  ({ bsPrefix, size: size2, htmlSize, className, isValid = false, isInvalid = false, id, ...props }, ref) => {
    const { controlId } = (0, import_react39.useContext)(FormContext_default);
...
var Switch = React68.forwardRef((props, ref) =>
  (0, import_jsx_runtime67.jsx)(FormCheck_default, {
    ...props,
    ref,
    type: 'switch',
  }),
...
var FloatingLabel = React69.forwardRef(({ bsPrefix, className, children, controlId, label, ...props }, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, 'form-floating');
  return (0, import_jsx_runtime69.jsxs)(FormGroup_default, {
    ...
    children: [
      children,
      (0, import_jsx_runtime68.jsx)('label', {
        htmlFor: controlId,
        children: label,
      }),
    ],
...
var InputGroupText = React71.forwardRef(({ className, bsPrefix, as: Component2 = 'span', ...props }, ref) => {
...
var InputGroupCheckbox = (props) =>
  (0, import_jsx_runtime72.jsx)(InputGroupText_default, {
...
var NavItem = React74.forwardRef((_ref, ref) => {
  let { as: Component2 = Button_default, active, eventKey } = _ref,
    options = _objectWithoutPropertiesLoose5(_ref, _excluded5);
...
var Nav = React75.forwardRef((_ref, ref) => {
  let {
    ...
    props = _objectWithoutPropertiesLoose6(_ref, _excluded6);
  const forceUpdate = useForceUpdate();
...
var ModalBody = React78.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var ModalFooter = React80.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var ModalTitle = React82.forwardRef(({ className, bsPrefix, as: Component2 = DivStyledAsH42, ...props }, ref) => {
...
var Modal = React83.forwardRef(
  (
    ...
    const renderBackdrop = (0, import_react43.useCallback)(
      (backdropProps) =>
...
var NavItem2 = React84.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var PopoverHeader = React89.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var PopoverBody = React90.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
  ...
  (
    ...
    return (0, import_jsx_runtime91.jsxs)('div', {
      ...
      children: [
        ...
        body
          ? (0, import_jsx_runtime90.jsx)(PopoverBody_default, {
              children,
            })
          : children,
      ],
...
function OverlayTrigger({
  ...
  const { onFocus, onBlur, onClick } = typeof children !== 'function' ? React95.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  const handleMouseOver = (0, import_react49.useCallback)(
    (...args) => {
      handleMouseOverOut(handleShow, args, 'fromElement');
    },
    [handleShow],
  );
  const handleMouseOut = (0, import_react49.useCallback)(
    (...args) => {
  ...
  return (0, import_jsx_runtime97.jsxs)(import_jsx_runtime96.Fragment, {
    children: [
      typeof children === 'function'
        ...
        : (0, import_react49.cloneElement)(children, triggerProps),
      (0, import_jsx_runtime95.jsx)(Overlay_default2, {
        ...props,
        show,
        onHide: handleHide,
        flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React96.forwardRef(({ children, ...props }, ref) =>
    (0, import_jsx_runtime99.jsxs)(PageItem, {
      ...props,
      ref,
      children: [
        (0, import_jsx_runtime98.jsx)('span', {
...
var Pagination = React97.forwardRef(({ bsPrefix, className, size: size2, ...props }, ref) => {
...
var Placeholder = React99.forwardRef(({ as: Component2 = 'span', ...props }, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React100.forwardRef(({ isChild = false, ...rest }, ref) => {
  const props = {
    min: 0,
    max: 100,
    animated: false,
  ...
  return (0, import_jsx_runtime103.jsx)('div', {
    ...
    children: children
      ? map(children, (child) =>
          (0, import_react50.cloneElement)(child, {
            isChild: true,
          }),
        )
      : renderProgressBar(
...
var Ratio = React101.forwardRef(({ bsPrefix, className, children, aspectRatio = '1x1', style, ...props }, ref) => {
...
var Spinner = React103.forwardRef(
  (
    ...
    return (0, import_jsx_runtime106.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames79.default)(
        className,
        bsSpinnerPrefix,
...
var SplitButton = React104.forwardRef(
  (
    ...
    (0, import_jsx_runtime108.jsxs)(Dropdown_default2, {
      ref,
      ...props,
...
var Stack = React105.forwardRef(({ as: Component2 = 'div', bsPrefix, className, direction, gap, ...props }, ref) => {
...
function useTabPanel(_ref) {
  let {
    ...
    props = _objectWithoutPropertiesLoose7(_ref, _excluded7);
  ...
  const { activeKey, getControlledId, getControllerId } = context5,
    rest = _objectWithoutPropertiesLoose7(context5, _excluded22);
...
var TabPanel = React106.forwardRef(
  ...
  (_ref2, ref) => {
    let { as: Component2 = 'div' } = _ref2,
      props = _objectWithoutPropertiesLoose7(_ref2, _excluded32);
    const [
      tabPanelProps,
      {
        isActive,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react52.useMemo)(
...
var TabContent = React109.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
...
var TabPane = React110.forwardRef(({ bsPrefix, transition, ...props }, ref) => {
  const [
    {
      className,
      // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
...
// node_modules/react-bootstrap/esm/Tab.js
var propTypes6 = {
  eventKey: import_prop_types8.default.oneOfType([
...
var Table = React111.forwardRef(
  ({ bsPrefix, className, striped, bordered, borderless, hover, size: size2, variant, responsive, ...props }, ref) => {
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime117.jsxs)(Tabs_default, {
    ...
    unmountOnExit,
    children: [
      (0, import_jsx_runtime116.jsx)(Nav_default2, {
        ...controlledProps,
        role: 'tablist',
        as: 'ul',
        variant,
...
var ToastFade = React113.forwardRef((props, ref) =>
  (0, import_jsx_runtime118.jsx)(Fade_default, {
    ...props,
    ref,
  ...
  ({ bsPrefix, closeLabel = 'Close', closeVariant, closeButton = true, className, children, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime120.jsxs)('div', {
      ...
      children: [
        children,
        closeButton &&
          (0, import_jsx_runtime119.jsx)(CloseButton_default, {
            'aria-label': closeLabel,
            variant: closeVariant,
            onClick: handleClick,
            'data-dismiss': 'toast',
...
var ToastBody = React116.forwardRef(({ className, bsPrefix, as: Component2 = 'div', ...props }, ref) => {
    ...
    return (0, import_jsx_runtime122.jsx)(ToastContext_default.Provider, {
      ...
      children:
        hasAnimation && Transition
          ? (0, import_jsx_runtime122.jsx)(Transition, {
              in: show,
              onEnter,
              onEntering,
              onEntered,
...
var ToggleButton = React119.forwardRef(
  ({ bsPrefix, name, className, checked, type, onChange, value, disabled, id, inputRef, ...props }, ref) => {
    ...
    return (0, import_jsx_runtime126.jsxs)(import_jsx_runtime125.Fragment, {
      children: [
        (0, import_jsx_runtime124.jsx)('input', {
          className: bsPrefix,
          name,
          type,
          value,
...
var ToggleButtonGroup = React120.forwardRef((props, ref) => {
  ...
  !(type !== 'radio' || !!name)
    ? true
      ...
      : (0, import_invariant2.default)(false)
    : void 0;
